...
class WC_NP_AGB_Shipping_Method extends WC_Shipping_Method {
    ...
    public function __construct( $instance_id = 0 ) {
        $this->id                 = 'np_agb_method';
        $this->instance_id        = absint( $instance_id );
        $this->method_title       = TranslatorCenter::run('Nova Poshta');
        $this->method_description = TranslatorCenter::run('Shipping by nova poshta of Ukraine');
        $this->supports           = array(
            'shipping-zones',
            'instance-settings',
