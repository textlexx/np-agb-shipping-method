...
function add_my_custom_shipping_method( $methods ) {
    ...
    $methods['agb_method'] = 'NpAgbShippingMethod\WC_My_Custom_Shipping_Method';
    return $methods;
}
    ...
    if ( class_exists( 'WC_Shipping_Method' ) ) {
        ...
        class WC_My_Custom_Shipping_Method extends WC_Shipping_Method {
            ...
            public function __construct( $instance_id = 0 ) {
                ...
                $this->method_title       = __( 'agb_method', 'woocommerce' );
                $this->method_description = __( 'agb_method', 'woocommerce' );
                $this->supports           = array(
                    'shipping-zones',
                    'instance-settings',
            ...
            public static function enqueue_admin_js() {
                $handle = 'wc-admin-shipping-agb-shipping';
