...
function add_agb_shipping_methods( array $methods ):array{
...
function init_shipping_methods_classes():void{

    if ( class_exists( 'WC_Shipping_Method' ) ){

        // In the future, maybe make this automatization
        //$classes = glob(PATH_CURRENT_PLG_NP_S_MT.'/shipping-methods-classes/*.php', GLOB_BRACE);   
        
        $classes = [
            PATH_CURRENT_PLG_NP_S_MT.'/shipping-methods-classes/WC_NP_AGB_Shipping_Method.php'
        ];

        foreach($classes as $cls){

            clearstatcache();
            if( !file_exists($cls) ) continue;
